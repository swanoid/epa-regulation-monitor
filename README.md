...
2. 환경보호청(EPA)는 특정 기간에 묶음으로 규제 발표
  - 규제 모니터링 알고리즘, 인공지능 기반 정책 예측, 기업 컴플라이언스 대응 일정 관리 등 기초 인사이트 제공

![](visuals/trend_weekly.png)
![](visuals/trend_monthly.png)

3. 주별 시계열은 규제 활동 패턴을 예측하고 alerting system을 만들 때 유용함
  - ex) EPA 발표량이 주 평균 대비 2배 증가 -> 사업 리스크 알림
4. 월별 분석은 규제 발표량의 구조적 패턴을 잘 보여줌
  - 장기적 모니터링에 특히 중요
5. 6월, 9월, 11월이 규제 활동의 주요 피크 시기
